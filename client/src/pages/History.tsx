        ...
        {videos.map((video) => (
          <div key={video.id} className="relative group">
            ...
            <button
              ...
              className="absolute top-2 right-2 p-1.5 bg-black/60 dark:bg-black/60 hover:bg-brand text-gray-300 dark:text-gray-300 hover:text-white dark:hover:text-white rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-200 shadow-md backdrop-blur-sm z-10 cursor-pointer border border-white/5 dark:border-white/5"
